...
module.exports =
  ...
  neighbor_6: (oppeeList, opend0, opend1, opend2, border, count1, step1, count0, step0)->
    totalList = (0 for color in [1..oppeeList.length])
      ...
      while index0 < range0
        ...
        if (sign and (
          ...
          if i0 >= border and i0 < n0-border and
            ...
            oppee = oppeeList[color]
            oppee[total+0] = offset0
            oppee[total+1] = (color<<28)|(scale<<24)|(i1<<12)|i0
            totalList[color] = total+2

        index0 = (index0+1)|0; offset0 = (offset0+step0)|0
      index1 = (index1+1)|0; offset1 = (offset1+step1)|0
    totalList

  neighbor_18: (oppeeList, opend0, opend1, opend2, border, count1, step1, count0, step0)->
    totalList = (0 for color in [1..oppeeList.length])
